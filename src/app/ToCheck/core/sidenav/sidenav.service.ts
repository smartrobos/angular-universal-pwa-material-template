...
export class SidenavService {
  ...
  constructor(
    ...
    this.mediaQueryService.isLowerThanMedium$.subscribe(isLowerThanLarge => {
     ...
     // console.log( 'SidenavState isLowerThanLarge Observable: ',this.sidenavState);
    });
  }
  /**
   * Sidenav Items
  ...
  public closeSidenav(){
    ...
    if(this.sidenav)
      ...
      console.log("Sidenav not defined - No Action");
  }
