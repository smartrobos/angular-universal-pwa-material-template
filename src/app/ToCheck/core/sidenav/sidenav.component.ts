...
import { componentDestroyed } from '@app/core/common/component-destroyed';
...
export class SidenavComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
   ...
   //   console.log( "this.sidenavService.sidenavState$.pipe" )
 ...
 //     console.log(new Date(),this.isCollapsed, this.isCollapsedState);
    });
  }
